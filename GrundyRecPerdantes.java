 ...
 * This version contains everything in the previous version plus the ability to remember losing situations
...
class GrundyRecPerdantes {
    ...
    boolean estPerdante(ArrayList<Integer> jeu) {
        ...
        if(tas==-1){
            //essai is a losing decomposition, add it to the losing positions array
            //Normalization
            essai.sort(null);
            essai.removeIf(n->n<3);

            //Add to the losing positions array
